...
export class ComposableObject {
  static keys = curry((fn: (value: string, index: number, array: string[]) => any, object: Record<string, any>): string[] => {
  ...
  static values = curry((fn: (value: unknown, index: number, array: unknown[]) => any, object: Record<string, any>): unknown[] => {
    if (typeof object !== 'object') {
      return ['Error:Non Object Provided'];
    }
  ...
  static entries = curry((fn: (value: [string, any], index: number, array: [string, any][]) => any, object: Record<string, any>): [string, unknown][] => {
    if (typeof object !== 'object') {
      return [['Error', 'Non Object Provided']];
    }
